...
# from ceam_public_health.components.diarrhea_disease_model import diarrhea_factory as build_diarrhea_model
...
def test_diarrhea_elevated_mortality():
    ...
    assert mortality_rate(severe_diarrhea_index)['severe_diarrhea'].all(), err_msg

    err_msg = "People with mild/moderate diarrhea should have no elevated mortality."
    a = mortality_rate(mild_diarrhea_index) == 0
    print(a)
    print(a.any())
