...
In a production simulation, data is supplied through a **data artifact** —
...
Note: The ``unmodeled_cause_specific_mortality_rate`` default is shown as
...
.. testcode::
   ...
   #        1990      1991   0.000000  0.019178  Female  mean_value   0.05
   #        1990      1991   0.000000  0.019178  Female lower_value   0.05
   #        1990      1991   0.000000  0.019178  Female upper_value   0.05
