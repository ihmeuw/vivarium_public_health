...
from ceam.framework.values import joint_value_combiner, joint_value_post_processor, rescale_post_processor
...
class Metrics:
    ...
    def setup(self, builder):
        ...
        self.disability_weight = builder.value('disability_weight', joint_value_combiner, lambda a: rescale_post_processor(joint_value_post_processor(a)))
        self.disability_weight.source = lambda index: pd.Series(1.0, index=index)
