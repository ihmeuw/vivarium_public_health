...
class CalculateIncidence():
    def __init__(self, disease_col, susceptible_col, age_group_id_min, age_group_id_max):
    ...
    def setup(self, builder):
        self.sorted_dict = make_age_bin_age_group_max_dict(age_group_id_min=age_group_id_min, age_group_id_max=age_group_id_max)
