...
from ceam_inputs import get_proportion, get_doctor_visit_costs, get_inpatient_visit_costs, modelable_entities
...
class HealthcareAccess:
    ...
    def setup(self, builder):
        ...
        self.utilization_proportion = builder.lookup(get_proportion(modelable_entities.outpatient_visits))
