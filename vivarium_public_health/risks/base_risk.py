...
class Risk:
    ...
    def setup(self, builder):
        ...
        self.exposure = builder.value.register_value_producer(f'{self._risk}_exposure',
    ...
    def _get_current_exposure(self, pop_index):
        propensity = self.propensity(pop_index)
