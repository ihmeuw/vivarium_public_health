...
class LinearScaleUp:
    ...
    configuration_defaults = {
        "treatment": {
            "start": {"date": "start", "value": "data",},
            "end": {"date": "end", "value": "data",},
        }
    }
    ...
    def _get_configuration_defaults(self) -> Dict[str, Dict]:
        return {
            self.configuration_key: LinearScaleUp.configuration_defaults["treatment"]
        }
    ...
    def setup(self, builder: Builder) -> None:
        ...
        ) = self._get_scale_up_date_endpoints(builder)
        (
    ...
    # noinspection PyMethodMayBeStatic
    def _get_scale_up_date_endpoints(
    ...
    def _get_scale_up_value_endpoints(
        ...
        def get_endpoint_value(endpoint_type: str) -> LookupTable:
            if scale_up_config[endpoint_type]["value"] == "data":
                ...
                endpoint = builder.lookup.build_table(
                    scale_up_config[endpoint_type]["value"]
                )
            return endpoint
    ...
    def _register_intervention_modifiers(self, builder: Builder):
        builder.value.register_value_modifier(
            f"{self.treatment}.exposure_parameters", modifier=self._coverage_effect,
        )
